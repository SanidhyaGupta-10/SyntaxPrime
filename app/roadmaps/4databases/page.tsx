...
export default function DatabaseCenter() {
  ...
  return (
    <div className="min-h-screen mt-16 w-full bg-transparent text-white px-6 py-16 flex flex-col gap-16 items-center overflow-hidden max-w-7xl mx-auto w-full">
